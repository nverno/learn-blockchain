...
public class UTXOPool {
  ...
  /** Adds a mapping from UTXO {@code utxo} to transaction output {@codetxOut} 
   * to the pool */
  ...
  /**
   * @return the transaction output corresponding to UTXO {@code utxo}, or null
   *         if {@code utxo} is not in the pool.
   */
